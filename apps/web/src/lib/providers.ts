...
export const demoProviders: DemoProvider[] = [
  {
    ...
    factory: "local",
    importFrom: "computer-use-sdk/local",
    config: "local()",
  ...
  },
  {
    ...
    domain: "openai.com",
    factory: "openai",
    importFrom: "computer-use-sdk/openai",
  ...
  },
  {
    ...
    factory: "anthropic",
    importFrom: "computer-use-sdk/anthropic",
  ...
  },
  {
    ...
    domain: "cua.ai",
    factory: "cua",
    importFrom: "computer-use-sdk/cua",
  ...
  },
  {
    ...
    factory: "browserbase",
    importFrom: "computer-use-sdk/browserbase",
  ...
  },
  {
    ...
    domain: "steel.dev",
    factory: "steel",
    importFrom: "computer-use-sdk/steel",
  ...
  },
  {
    ...
    importFrom: "computer-use-sdk/hyperbrowser",
  ...
  },
  {
    ...
    factory: "browserUse",
    importFrom: "computer-use-sdk/browser-use",
  ...
  },
  {
    ...
    domain: "skyvern.com",
    factory: "skyvern",
    importFrom: "computer-use-sdk/skyvern",
  ...
  },
  {
    ...
    factory: "openhands",
    importFrom: "computer-use-sdk/openhands",
  ...
  },
  {
    ...
    factory: "stagehand",
    importFrom: "computer-use-sdk/stagehand",
  ...
  },
  {
    ...
    domain: "agentql.com",
    factory: "agentql",
    importFrom: "computer-use-sdk/agentql",
  ...
  },
  {
    ...
    factory: "midscene",
    importFrom: "computer-use-sdk/midscene",
    config: "midscene()",
  ...
  },
  {
    ...
    factory: "nanobrowser",
    importFrom: "computer-use-sdk/nanobrowser",
  ...
  },
  {
    ...
    importFrom: "computer-use-sdk/playwright-mcp",
  ...
  },
  {
    ...
    factory: "firecrawl",
    importFrom: "computer-use-sdk/firecrawl",
...
export const matrix: MatrixRow[] = [
  { name: "TryCUA", monogram: "CU", domain: "cua.ai", browser: Y, desktop: Y, api: Y, vision: Y, oss: N, pkg: "computer-use-sdk/cua", group: "cloud" },
  { name: "OpenAI Computer Use", monogram: "OA", domain: "openai.com", browser: Y, desktop: Y, api: Y, vision: Y, oss: N, pkg: "computer-use-sdk/openai", group: "cloud" },
  { name: "Anthropic Computer Use", monogram: "AN", domain: "anthropic.com", browser: Y, desktop: Y, api: Y, vision: Y, oss: N, pkg: "computer-use-sdk/anthropic", group: "cloud" },
  { name: "Browserbase", monogram: "BB", domain: "browserbase.com", browser: Y, desktop: N, api: Y, vision: Y, oss: N, pkg: "computer-use-sdk/browserbase", group: "cloud" },
  { name: "Steel.dev", monogram: "ST", domain: "steel.dev", browser: Y, desktop: N, api: Y, vision: P, oss: N, pkg: "computer-use-sdk/steel", group: "cloud" },
  { name: "Hyperbrowser", monogram: "HB", domain: "hyperbrowser.ai", browser: Y, desktop: N, api: Y, vision: Y, oss: N, pkg: "computer-use-sdk/hyperbrowser", group: "cloud" },
  { name: "Browser Use", monogram: "BU", domain: "browser-use.com", browser: Y, desktop: N, vision: Y, oss: Y, api: N, pkg: "computer-use-sdk/browser-use", group: "oss" },
  { name: "Skyvern", monogram: "SV", domain: "skyvern.com", browser: Y, desktop: N, vision: Y, oss: Y, api: N, pkg: "computer-use-sdk/skyvern", group: "oss" },
  { name: "OpenHands", monogram: "OH", domain: "all-hands.dev", browser: Y, desktop: P, vision: Y, oss: Y, api: N, pkg: "computer-use-sdk/openhands", group: "oss" },
  { name: "Stagehand", monogram: "SH", domain: "docs.stagehand.dev", browser: Y, desktop: N, vision: P, oss: Y, api: N, pkg: "computer-use-sdk/stagehand", group: "oss", note: "AI-assisted" },
  { name: "AgentQL", monogram: "AQ", domain: "agentql.com", browser: Y, desktop: N, vision: P, oss: P, api: N, pkg: "computer-use-sdk/agentql", group: "oss", note: "DOM AI" },
  { name: "Midscene.js", monogram: "MI", domain: "midscenejs.com", browser: Y, desktop: N, vision: Y, oss: Y, api: N, pkg: "computer-use-sdk/midscene", group: "oss" },
  { name: "Nanobrowser", monogram: "NB", domain: "nanobrowser.ai", browser: Y, desktop: N, vision: Y, oss: Y, api: N, pkg: "computer-use-sdk/nanobrowser", group: "oss" },
  { name: "Playwright MCP", monogram: "PW", domain: "playwright.dev", browser: Y, desktop: N, vision: N, oss: Y, api: N, pkg: "computer-use-sdk/playwright-mcp", group: "oss" },
  { name: "Local", monogram: "LO", domain: "playwright.dev", browser: Y, desktop: P, vision: N, oss: Y, api: N, pkg: "computer-use-sdk/local", group: "transport", note: "Bundled Playwright" },
  { name: "Firecrawl", monogram: "FC", domain: "firecrawl.dev", browser: Y, desktop: N, vision: N, oss: N, api: Y, pkg: "computer-use-sdk/firecrawl", group: "transport", note: "Scrape add-on" },
];
